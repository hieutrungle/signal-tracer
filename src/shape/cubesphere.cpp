...
// MODIFIED by Hieu Le (hieu.tg.le@gmail.com)
// CREATED: 2018-09-20
// UPDATED: 2022-12-19
///////////////////////////////////////////////////////////////////////////////
...
// OpenGL VAO, VBO, and EBO must be set before calling it
///////////////////////////////////////////////////////////////////////////////
void Cubesphere::draw(cy::GLSLProgram& shader_program, const glm::mat4& model, const glm::mat4& view, const glm::mat4& projection) {
    shader_program.Bind();
...
void Cubesphere::setup_draw() {
    glGenVertexArrays(1, &m_vao);
    glBindVertexArray(m_vao);

    glGenBuffers(1, &m_vbo);
    glBindBuffer(GL_ARRAY_BUFFER, m_vbo);
    glBufferData(GL_ARRAY_BUFFER, getInterleavedVertexSize() * sizeof(float), getInterleavedVertices(), GL_STATIC_DRAW);
